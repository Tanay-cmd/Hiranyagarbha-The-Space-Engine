...
# ==== PLANET DEFINITIONS (Position, radius, mass, color, vel_vect, screen, is_human)
sun = Planet((0, 0), 50, 1.989e30, (255, 255, 0), (0, 0), SCREEN, True)
...
while run:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if initial_pos:
                ...
                if vel_vector.length() > 0:
                    ...
                    new_planet = Planet(((initial_pos[0] - WIDTH/2) * (1/SCALE) , (initial_pos[1] - HEIGHT/2) * (1/SCALE)), 13, 5.972e26, (255, 0, 0), (vel_vector.x, vel_vector.y), SCREEN, False)
    ...
    for planet in planet_list:
        if planet.position.x * SCALE > 1920  or planet.position.y * SCALE > 1080  :
